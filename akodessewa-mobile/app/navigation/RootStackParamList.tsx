...
export type RootStackParamList = {
    ...
    MotoHome: undefined;
    VehicleSearch: { mode?: string; vin?: string; vehicle_id?: string; year?: string; make?: string; model?: string; engine?: string; moto_brand?: string; moto_model?: string; moto_year?: string; moto_part_type?: string } | undefined;
    Garages: undefined;
    SupplierProfile: { slug: string; name: string };
